...
echo "<table border='1' align='center'>";
    echo "<tbody>";
        echo "<tr>";
            echo "<td colspan='10' class='titulo1'><h2>Listado de tickets habilitados para Verificación de Efectividad</h2></td>";
        echo "</tr>";
        echo "<tr>";
        ...
        echo "</tr>";
        $sentencia = "SELECT * FROM ticket WHERE estado = 'P/Verificar'";
        ...
        { 
            ...
            $sentencia1 = 'SELECT * FROM respuesta WHERE nombretk = "' . $nombretk. '"';
                ...
                echo "<td class='detalle'>";
                    echo "<form action='efectividad.php' method='post' target='principal'>";
