	...
	echo "<tbody>";
		...
		echo "</tr>";
            ...
            { 
                ...
                if($numeroaccion == 4){
                    echo "<tr>";
                        ...
                        echo "<td colspan=1 align=left>Realizada el día ".date("d/m/Y", strtotime($fechaaccion1))." por ".$verificador.", las acciones se cumplieron: ".$vaccion." debido a: ".$accion."</td>";
                    echo "</tr>";
                }
            }
			...
			echo "<tr>";
                ...
                echo "<td colspan=1 align=left>".$persona10." el día ".date("d/m/Y", strtotime($fechaaccion10))."</td>";
			echo "</tr>";
			echo "<tr>";
            ...
            $cerrador=$_POST['persona'];
            $fechacierre=$_POST['fechaaccion'];
            $vaccion11=$_POST['vaccion'];
            $acciones=$_POST['acciones'];
            $observacioncierre=$_POST['justificacion'];

            $sentencia = "INSERT INTO cierre (nombretk, cerrador, fecha, vaccion, acciones, observacioncierre) VALUES ('".$numerotk."', '".$cerrador."', '".$fechacierre."', '".$vaccion11."', '".$acciones."', '".$observacioncierre."')";
            $consulta = mysqli_query($iden,$sentencia);
        
            $sentencia = "UPDATE ticket SET estado='Cerrado' WHERE nombretk LIKE '".$numerotk."'";
            $consulta = mysqli_query($iden,$sentencia);
            ...
            echo "<tr>";
                ...
                echo "<form action='varmiassinres.php' method='post'>";
                echo "<tr>";
