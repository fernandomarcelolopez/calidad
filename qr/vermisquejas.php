...
echo "  <table>";
	echo "<tbody>";
		echo "<tr>";
			echo "<td class='titulo1' colspan='9' align=center><h2>Lista de Quejas de mi área sin tratar</h2</td>";
		echo "</tr>";
		echo "<tr>";
		...
		echo "</tr>";
		$sentencia = "SELECT * FROM quejas WHERE destino = '". $area."' AND estado = 'Sin Tratar' AND tipo = 'Queja'";
		...
		{
			echo "<tr>";
				echo "<td  class='titulo1'colspan='9'>Sin Quejas dirigidas al área sin tratar</Font></td>";
			echo "</tr>";
		}	
	echo "</tbody>";
echo "  </table>";
