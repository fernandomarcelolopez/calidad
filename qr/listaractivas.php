...
echo "  <table>";
	echo "<tbody>";
		echo "<tr>";
			echo "<td class='titulo1' colspan='10' align=center><h2>Lista de Registros Activos de mi área del año '".$actual."'</h2</td>";
		echo "</tr>";
		echo "<tr>";
		...
		echo "</tr>";
		$sentencia = "SELECT * FROM quejas WHERE fechareg LIKE '%". $actual."%' AND estado <>'Cerrado'";
