...
echo "<form action='vermisquejas.php' method='post'>";
	echo "<table border='1' align='center'>";
		...
		echo "<tbody>";
			echo "<tr>";
				echo "<td class='titulo1' colspan='2' align=center><h2>DETALLE DE REGISTRO DE QUEJAS, RECLAMOS O FELICITACIONES</h2></td>";
			echo "</tr>";
			echo "<tr>";
...
/*			echo "<tr>";
				...
				echo "<td colspan=1 align=left>Cargado por ".$personacarga." el día ".$fechahoy." a horas ".$horahoy."</td>";
			echo "</tr>";
*/			echo "<tr>";
