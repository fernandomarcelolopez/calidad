...
echo "  <table>";
	echo "<tbody>";
		echo "<tr>";
			echo "<td class='titulo1' colspan='10' align=center><h2>Lista de Registros Tratados para Cerrar</h2</td>";
		echo "</tr>";
		echo "<tr>";
		...
		echo "</tr>";
		$sentencia = "SELECT * FROM quejas WHERE estado = 'Verificado'";
		...
		{ 
			...
			echo "<tr>";
				...
				echo "<td class='detalle'>";
					echo "<form action='cargacierre.php' method='post' target='principal'>";
		...
		{
			echo "<tr>";
				echo "<td  class='titulo1'colspan='10'>Sin Registros Verificados para cierre</Font></td>";
			echo "</tr>";
		}	
	echo "</tbody>";
echo "  </table>";
