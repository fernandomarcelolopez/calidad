...
echo "  <table>";
	echo "<tbody>";
		echo "<tr>";
			echo "<td class='titulo1' colspan='9' align=center><h2>Lista de Reclamos de mi área sin tratar</h2</td>";
		echo "</tr>";
		echo "<tr>";
			echo "<td class='titulo2'>Registro N°</td>";
		...
		echo "</tr>";
		$sentencia = "SELECT * FROM quejas WHERE destino = '". $area."' AND estado = 'Sin Tratar' AND tipo = 'Reclamo'";
		...
		{ 
			...
			echo "<tr>";
				echo "<td class='detalle'>". $nombreqrf."</td>";
		...
		{
			echo "<tr>";
				echo "<td  class='titulo1'colspan='9'>Sin reclamos dirigidas al área sin tratar</Font></td>";
			echo "</tr>";
		}	
	echo "</tbody>";
echo "  </table>";
