...
echo "  <table>";
	echo "<tbody>";
		echo "<tr>";
			echo "<td class='titulo1' colspan='9' align=center><h2>Lista de Tickets Generados por el Usuario</h2</td>";
		echo "</tr>";
		echo "<tr>";
		...
		echo "</tr>";
		$sentencia = "SELECT * FROM ticket WHERE idpersona = '". $usuario."'";
			...
			echo "<tr>";
				...
				echo "<td class='detalle'>";
					echo "<form action='verdetalle.php' method='post' target='principal'>";
						...
						echo "<input type='hidden' value='1' name='generado' id:'numero' />";
		...
		{
			echo "<tr>";
				echo "<td  class='titulo1'colspan='9'>Sin Tickets generados</Font></td>";
			echo "</tr>";
		}	
	echo "</tbody>";
echo "  </table>";
