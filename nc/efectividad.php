...
$sentencia6 = 'SELECT * FROM personas WHERE Idpersonas = "' . $idper. '"';
...
echo "<table border='1' align='center'>";
	...
	echo "<tbody>";
		...
		echo "</tr>";
            ...
            echo "<form action='creaefectividad.php' method='post'>";
                echo "<tr>";
                    echo "<td class='titulo1' colspan=2><h2>REGISTRO DE VERIFICACION DE EFECTIVIDAD</h2></td>";
                echo "</tr>";
				echo "<tr>";
					echo "<td colspan=1 class='titulo2' style='text-align:left'>Control Efectividad de las Acciones</td>";
					echo "<td colspan='1' align=left> Las acciones fueron eficaces? ";
						echo "<input id='vaccion' name='vaccion' type='radio' value='SI'/>Si";
						echo "<input id='vaccion' name='vaccion' type='radio' value='NO'/>No";
					echo "</td>";
				echo "</tr>";
				echo "<tr>";
					echo "<td colspan=2 align=left><textarea name='justificacion' rows='2' cols='130' required maxlength='260' placeholder='Escribe aqui la Justificación'></textarea></td>";
                ...
                echo "<tr>";
                    echo "<td colspan='2' align='center'>";
                        echo "<input type='submit' value='CARGAR VERIFICACION' name='submit'/>";
                    echo "</td>";
                echo "</tr>";
            echo "</form>";
    echo "</tbody>";
