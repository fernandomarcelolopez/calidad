...
echo "<form action='versector.php' method='post' target='principal'>";
	echo "<table>";
	echo "<tbody>";
		echo "<tr>";
		...
		{ 
			...
			echo "<tr>";
				...
				echo "<td class='detalle'>";
					echo "<form action='cambiasector.php' method='post' target='principal'>";
					echo "<input type='hidden' value='".$idsector."' name='sector' id:'sector' />";
