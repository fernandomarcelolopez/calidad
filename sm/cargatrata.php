...
$horareg=$_POST['hora'];
$fechareunion1=$_POST['fechareunion1'];
...
$sentencia = "UPDATE sugerencia SET fechareunion1='".$fechareunion1."', resultado= '".$resultado."', acciones= '".$acciones."', plazos= '".$plazos."', idtrata= '".$idper."', fechatrata= '".$fechareg."', horatrata= '".$horareg."', estado= 'C/Tratamiento' WHERE idsm='".$idsm."'";
$consulta = mysqli_query($iden,$sentencia);
