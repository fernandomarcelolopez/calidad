...
$sentencia = "UPDATE sugerencia SET fechareunion='".$fechareunion."', factibilidad= '".$factibilidad."', impacto= '".$impacto."', costos= '".$costos."', idfactibilidad= '".$idper."', fechafactibilidad= '".$fechareg."', horafactibilidad= '".$horareg."', estado= 'C/Factibilidad' WHERE idsm='".$idsm."'";
$consulta = mysqli_query($iden,$sentencia);
