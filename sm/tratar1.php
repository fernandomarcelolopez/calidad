...
echo "  <table>";
	echo "<tbody>";
		echo "<tr>";
			echo "<td class='titulo1' colspan='7' align=center><h2>Lista de Sugerencias con planillas</h2</td>";
		echo "</tr>";
		echo "<tr>";
		...
		echo "</tr>";
		$sentencia = "SELECT * FROM sugerencia WHERE estado = 'C/Planilla'";
		...
		{ 
			...
			echo "<tr>";
				...
				echo "<td class='detalle'>";
					echo "<form action='regtrata1.php' method='post' target='principal'>";
					echo "<input type='hidden' value='".$idsm."' name='idsm' id:'idam' />";
					echo "<input type='submit' value='Reg. Factibilidad' name='submit'/>";
					echo "</form>";	
				echo "</td>";
			echo "</tr>";
			$bandera = $bandera +1;
