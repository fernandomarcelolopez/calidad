...
echo "  <table>";
	echo "<tbody>";
		echo "<tr>";
			echo "<td class='titulo1' colspan='7' align=center><h2>Lista de Sugerencias con factibilidad</h2</td>";
		echo "</tr>";
		echo "<tr>";
		...
		echo "</tr>";
		$sentencia = "SELECT * FROM sugerencia WHERE estado = 'C/Factibilidad'";
		...
		{ 
			...
			echo "<tr>";
				...
				echo "<td class='detalle'>";
					echo "<form action='regtrata.php' method='post' target='principal'>";
					echo "<input type='hidden' value='".$idsm."' name='idsm' id:'idam' />";
					echo "<input type='submit' value='Reg. Tratamiento' name='submit'/>";
					echo "</form>";	
				echo "</td>";
			echo "</tr>";
			$bandera = $bandera +1;
		...
		{
			echo "<tr>";
				echo "<td  class='titulo1'colspan='7'>Sin Sugerencias con planilla</Font></td>";
			echo "</tr>";
		}	
	echo "</tbody>";
echo "  </table>";
