...
echo "<form action='cargaefecti.php' method='post'>";
	echo "<table border='1' align='center'>";
		...
		echo "<tbody>";
			...
			echo "</tr>";
			echo "<tr>";
				echo "<td class='titulo2' colspan='2'><h2>Carga de Registro de Efectividad</h2></td>";
			echo "</tr>";
			echo "<tr>";
				echo "<td class='titulo2' colspan='1' style='text-align:left'>Resultado del análisis de la Efectividad de lo realizado</td>";
				echo "<td colspan='1' align=left><textarea name='efectividad' rows='2' cols='110' required maxlength='360' placeholder='Describa si lo decidido fue efectivo'></textarea></td>";
			echo "</tr>";
