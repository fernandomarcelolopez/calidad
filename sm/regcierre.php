...
echo "<form action='cargacierre.php' method='post'>";
	echo "<table border='1' align='center'>";
		...
		echo "<tbody>";
			...
			echo "</tr>";
			echo "<tr>";
				echo "<td class='titulo2' colspan='2'><b>REGISRO DE TRATAMIENTO</b></td>";
			echo "</tr>";
			echo "<tr>";
				echo "<td class='titulo2' colspan='1' style='text-align:left'>Reunión realizada el </td>";
			...
			echo "</tr>";
			echo "<tr>";
				echo "<td class='titulo2' colspan='2'><h2>Carga de Registro de Cierre</h2></td>";
			echo "</tr>";
			echo "<tr>";
				echo "<td class='titulo2' colspan='1' style='text-align:left'>Observaciones del cierre</td>";
				echo "<td colspan='1' align=left><textarea name='cierre' rows='2' cols='110' required maxlength='220' placeholder='Observación de cierre'></textarea></td>";
			echo "</tr>";
